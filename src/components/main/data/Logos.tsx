...
const Logos = () => {
  return (
    <div className="w-full mt-[85px] flex justify-between items-center">
      <Image src={Kcc} alt="방송통신위원회 로고" width={172} />
      <Image src={Bizplay} alt="bizplay 로고" width={172} />
      <Image src={Amazon} alt="AWS 로고" width={172} />
      <Image src={TheIMC} alt="TheIMC 로고" width={172} />
      <Image src={Intellius} alt="Intellius 로고" width={172} />
      <Image src={FluentT} alt="FluentT 로고" width={172} />
    </div>
  );
};
